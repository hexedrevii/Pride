...
namespace Pride
{
    ...
    {
    public:
        /// @brief Asset manager for those who do not want to handle them themselves.
        ...
        */
        void register_asset_relative(const std::string_view name, const std::filesystem::path& path, SDL_ScaleMode mode = SDL_SCALEMODE_LINEAR);
